...
public class CreateBucket {
    ...
    public static void main(String[] args) {
        ...
        S3Client s3Client = S3Client.builder().region(Region.of("ap-northeast-1")).credentialsProvider(
                StaticCredentialsProvider.create(credentials)
        ).build();

        CreateBucketRequest bucketRequest = CreateBucketRequest.builder().bucket("mandhena1-new-aws-s3").build();
